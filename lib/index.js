...
/**
* NOTE: the original C++ code and copyright notice is from the [Boost library]{http://www.boost.org/doc/libs/1_55_0/boost/math/special_functions/zeta.hpp}.
*
...
function zeta( s ) {
	...
	var Y;
	if ( sc === 0 ) {
		// Evaluation of zeta function at pole `sc`
		return NaN;
	}
