...
*      where `B_m` are the Bernoulli numbers.
*
*   8. For positive negative integers, we use precomputed values, which are useful for certain infinite series calculations.
*
*   Notes:
*
*/
...
function zeta( s ) {
	...
	// Check for evaluation of zeta function at a pole:
	if ( s === 1 ) {
		return NaN;
	}
